...
def fetch_arera_tariffs():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            # Look for tariff information in the page
...
def create_arera_tou_structure(tariffs):
    ...
    df['day_type'] = df['timestamp'].dt.dayofweek.map({
