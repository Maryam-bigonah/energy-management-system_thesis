# Load Profile Generator (LPG) - Real Data Instructions

## 🚨 **CRITICAL: Current Data is NOT from Real LPG**

The current load data in `project/data/load_24h.csv` and `project/data/load_8760.csv` is **GENERATED/SIMULATED** data, NOT from the real Load Profile Generator.

## ✅ **REQUIRED: Use Real LPG Software**

To get **REAL** load data, you must:

### **Step 1: Download LPG Software**
1. Go to: https://www.loadprofilegenerator.de
2. Download the Windows desktop application
3. Install and run LPG

### **Step 2: Configure 4 Household Types**
Create these 4 household types in LPG:
